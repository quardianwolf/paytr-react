...
export class PayTRClient {
  ...
  public async getToken( params: PayTRGetTokenParams): Promise<PayTRGetTokenResponse> {
    const {
      merchant_id,
      merchant_key,
      merchant_salt,
  ...
  public async directApi( params: PayTRDirectApiParams): Promise<PayTRDirectApiResponse> {
    const {
      merchant_id,
      merchant_key,
      merchant_salt,
    ...
    const response = await this._client.request<
      any,
      AxiosResponse<PayTRDirectApiRawResponse>
    >(request);
